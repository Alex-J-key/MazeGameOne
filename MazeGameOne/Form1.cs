    ...
    */
    ...
    public partial class Form1 : Form
    {
        ...
        Status[,] Cells = {
            ...
            {Status.Wall, Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Target,Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall},
            ...
            {Status.Wall, Status.Empty, Status.Empty, Status.Empty, Status.Wall,  Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Target,Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Wall,  Status.Empty, Status.Empty, Status.Empty, Status.Wall},
            {Status.Wall, Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Wall,  Status.Wall,  Status.Empty, Status.Wall,  Status.Wall,  Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Wall},
            {Status.Wall, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Wall,  Status.Empty, Status.Wall,  Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Empty, Status.Wall},
            ...
            */
            ...
            for (int i = 0; i <= 18; i++)
            {
                for (int j = 0; j <= 18; j++)
                {
                    ...
                    {
                        g.FillRectangle(BrushGreen, j*50, i*50, 40, 40);
                    }
                }
            }
        ...
        private void Form1_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (Cells[CoordinatesY, CoordinatesX] == Status.Target)
                MessageBox.Show("Well done you did it!");
            Cells[CoordinatesY, CoordinatesX] = Status.Empty;
            this.Text = "Game - " + (CoordinatesX-1) + " " + (CoordinatesY-1);
        }
    }
}
